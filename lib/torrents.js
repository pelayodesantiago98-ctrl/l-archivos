 ...
 *
 * Y los datos con el, que es lo que libera la cuota. Suena a que se pierde la
 ...
 * Es lo que se pide -- que la cuota quede libre para la siguiente -- pero es un
  ...
  try {
    ...
    for (const t of torrents) {
      ...
      console.log('[torrents] terminado y retirado: ' + t.name
        + ' (' + gb(t.totalSize || 0) + ' de cuota libres)');
    }
  } catch (err) {
